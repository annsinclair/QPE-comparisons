#!/usr/bin/env python
"""
Filename: he_clean.py
Author: Ann Sinclair
Date: 2026-04-07
Version: 1.0
Description: Clean downloaded hydro-estimator files and save as netCDF files
"""
...
file_path = 'path/to/he_files'
# USER INPUT! location of downloaded data
grid_path = 'path/to/he_grid_file'
# USER INPUT! location to store cleaned data
save_path = '/path/to/store/cleaned_data/he.nc'

# define boundry conditions (OPTIONAL: these values will crop the data to
# southern California)
...
# rename
ds_rename = ds_merged.rename(
    {'lines': 'x', 'elems': 'y', 'latitude': 'lat', 'longitude': 'lon'})
