...
# define paths
file_path = 'path/to/era5_files'                   # USER INPUT! location of downloaded data (OR to put downloaded data)
save_path = '/path/to/store/cleaned_data/era5.nc'  # USER INPUT! location to store cleaned data
