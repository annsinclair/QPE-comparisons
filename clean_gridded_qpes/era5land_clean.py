...
# define paths
file_path = '/projects/b1045/asinclair/ARs/feb2025/era5land/era5land_files/era5land.nc'                   # USER INPUT! location of downloaded data (OR to put downloaded data)
save_path = '/projects/b1045/asinclair/ARs/feb2025/era5land/era5land_clean.nc'  # USER INPUT! location to store cleaned data
