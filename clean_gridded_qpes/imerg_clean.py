...
# define paths
file_path = 'path/to/imerg_files'                  # USER INPUT! location of downloaded data
save_path = '/path/to/store/cleaned_data/imerg.nc' # USER INPUT! location to store cleaned data
