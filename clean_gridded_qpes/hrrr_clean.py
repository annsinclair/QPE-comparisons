#!/usr/bin/env python
"""
Filename: hrrr_clean.py
Author: Ann Sinclair
Date: 2026-04-07
Version: 1.0
Description: Clean downloaded HRRR files and save as netCDF files
"""
...
file_path = 'path/to/hrrr_files'
# USER INPUT! location to store cleaned data
save_path = '/path/to/store/cleaned_data/hrrr.nc'
...
# rename
hrrr_rename = hrrr_da.rename(
    {'initial_time0_hours': 'time', 'gridlat_0': 'lat', 'gridlon_0': 'lon'})
