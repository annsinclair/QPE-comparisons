...
# define paths
file_path = '/projects/b1045/asinclair/ARs/feb2025/hrrr/hrrr_files'                  # USER INPUT! location of downloaded data
save_path = '/projects/b1045/asinclair/ARs/feb2025/qpe_datasets/hrrr.nc' # USER INPUT! location to store cleaned data
